...
train_data = pd.read_csv("data/processed/train_data.csv").dropna(subset=['content'])
test_data = pd.read_csv("data/processed/test_data.csv").dropna(subset=['content'])
...
vectorizer = TfidfVectorizer(max_features=params['feature_engineering']['max_features'])
